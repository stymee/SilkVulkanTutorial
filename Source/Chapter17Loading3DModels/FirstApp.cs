...
public class FirstApp : IDisposable
{
    ...
    private void loadGameObjects()
    {
        ...
        var vase = LveGameObject.CreateGameObject();
        vase.Model = ModelUtils.LoadModelFromFile(vk, device, "Assets/flat_vase.obj");
        vase.Transform.Translation = new(1.0f, 0.0f, 1.0f);
        gameObjects.Add(vase);
