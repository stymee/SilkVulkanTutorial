...
public partial class FirstApp : IDisposable
{
    ...
    public void Run()
    {
        ...
        var shaderuse = ShaderStageFlags.VertexBit | ShaderStageFlags.FragmentBit | ShaderStageFlags.MeshBitExt | ShaderStageFlags.TaskBitExt;
    ...
    private void loadGameObjects()
    {
        ...
        cube.Transform.Translation = new(-1.25f, .751f, -1.25f);
        cube.Transform.Scale = new(0.25f);
