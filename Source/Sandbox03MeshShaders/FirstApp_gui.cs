...
public partial class FirstApp
{
    ...
    private float triangleSpacing = 1;
    private float triangleHeight = 1;
    private float triangleWidth = 1;
    ...
    private void FirstAppGuiInit()
    {
        ...
        triangleCount = (int)sboMeshTest.TriangleCount;
        triangleSpacing = sboMeshTest.TriangleSpacing;
        triangleHeight = sboMeshTest.TriangleHeight;
        triangleWidth = sboMeshTest.TriangleWidth;
    }
    ...
    private void FirstAppGuiUpdate()
    {
        ...
        ImGui.Begin("Settings");
        {
            ...
            // triangle mesh shader stuff
            ImGui.NewLine();
            ImGui.Separator();
            ImGui.Text("Triangle Count");
            if (ImGui.SliderInt("##triangleCount", ref triangleCount, 1, 100))
            {
                sboMeshTest = sboMeshTest with { TriangleCount = (uint)triangleCount };
                sboMeshTestBuffer.WriteToBuffer(sboMeshTest);
            }
            ImGui.Text("Triangle Spacing");
            if (ImGui.SliderFloat("##triangleSpacing", ref triangleSpacing, 0.1f, 5f))
            {
                sboMeshTest = sboMeshTest with { TriangleSpacing = triangleSpacing };
                sboMeshTestBuffer.WriteToBuffer(sboMeshTest);
            }

            // haven't implemented height/width yet
            //ImGui.Text("Triangle Height");
            //if (ImGui.SliderFloat("##triangleHeight", ref triangleHeight, 0.1f, 5f))
            //{
            //    sboMeshTest = sboMeshTest with { TriangleHeight = triangleHeight };
            //    sboMeshTestBuffer.WriteToBuffer(sboMeshTest);
            //}
            //ImGui.Text("Triangle Width");
            //if (ImGui.SliderFloat("##triangleWidth", ref triangleWidth, 0.1f, 5f))
            //{
            //    sboMeshTest = sboMeshTest with { TriangleWidth = triangleWidth };
            //    sboMeshTestBuffer.WriteToBuffer(sboMeshTest);
            //}
        ...
        {
            var fps = $"FPS {ImGui.GetIO().Framerate,7:0.00}";
            ...
            ImGui.Text($"{status,-20} | {fps} | {mems} | {m2} | {m3} | {v}");
        }
