...
public class LveMeshPipeline : IDisposable
{
    ...
    public LveMeshPipeline(Vk vk, LveDevice device, string taskPath, string meshPath, string fragPath, PipelineConfigInfo configInfo, string renderSystemName = "unknown")
    {
        this.vk = vk;
        this.device = device;
    ...
    public unsafe static void DefaultPipelineConfigInfo(ref PipelineConfigInfo configInfo)
    {
        ...
        //configInfo.BindingDescriptions = default;
        //configInfo.AttributeDescriptions = default;
